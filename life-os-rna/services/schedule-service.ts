...
export type ScheduleModule = "Morning" | "Deep Work" | "Movement" | "Lab" | "Reflection"
...
export class ScheduleService {
  ...
  async generate(week: string, inputs: ScheduleInputs): Promise<WeeklySchedule> {
    ...
    const template: ScheduleBlock[] = [
      ...
      { start: "17:30", end: "18:30", module: "Lab", notes: "Family/Build time" },
